...
Fork https://github.com/`__REPOSITORY__` into your GitHub account.

## Clone your newly forked repository onto your local machine

```bash
git clone git@github.com:[your username]/__REPOSITORY_NAME__.git
...
```bash
git remote add upstream git://github.com/__REPOSITORY__.git
```
 ...
 * Issue Tracker - https://github.com/`__REPOSITORY__`/issues
 * Chat - `__TBD__`
